...
/*package*/ class Constants {
    /** The script.js appears in the lighting app menu. */
/*package*/ static final int FLAG_APP_MENU = 2;
    /** The script.js appears in the item menu. */
/*package*/ static final int FLAG_ITEM_MENU = 4;
    /** The script.js appears in the custom menu. */
/*package*/ static final int FLAG_CUSTOM_MENU = 8;
    /** Mandatory: the identifier of the script.js, should be something like R.raw.your_script */
...
/*package*/ static final String INTENT_EXTRA_SCRIPT_FLAGS = "f";
    /** Optional: name of the script.js (default is the activity name) */
/*package*/ static final String INTENT_EXTRA_SCRIPT_NAME = "n";
    /** Optional: execute the script.js right after loading it (default is false) */
/*package*/ static final String INTENT_EXTRA_EXECUTE_ON_LOAD = "e";
    /** Optional: delete the script.js right after loading and (presumably) executing it.
     * This is useful when the script.js is meant to configure the home screen, create items or
